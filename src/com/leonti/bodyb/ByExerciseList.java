...
public class ByExerciseList extends ListActivity {
    ...
    private void fillData() {
        ...
        SimpleCursorAdapter excercises = 
        	    new SimpleCursorAdapter(this, R.layout.by_exercise_list_row, mExercisesForDayCursor, from, to);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        int ExIdIndex = mExercisesForDayCursor.getColumnIndexOrThrow(ExcercisesDbAdapter.KEY_EXERCISEID);
        Intent i = new Intent(this, LogEntries.class);
        i.putExtra(ExcercisesDbAdapter.KEY_ROWID, mExercisesForDayCursor.getLong(ExIdIndex));
        startActivity(i);
        /*
