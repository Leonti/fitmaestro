...
public class ExcercisesDbAdapter {
    ...
    public static final String KEY_EXCERCISES = "excercises"; //for sets
    public static final String KEY_GROUPID = "group_id"; //for exercises
    public static final String KEY_EXCERCISEID = "excercise_id"; //for log
    ...
    private static final String EXCERCISES_CREATE =
    ...
    private static final String DATABASE_EXCERCISES_TABLE = "excercises";
    ...
    public long createExcercise(String title, String desc, int type, long group_id, long site_id) {
        ...
        return mDb.insert(DATABASE_EXCERCISES_TABLE, null, initialValues);
    }

    public boolean deleteExcercise(long rowId) {

        return mDb.delete(DATABASE_EXCERCISES_TABLE, KEY_ROWID + "=" + rowId, null) > 0;
    }

    public Cursor fetchExcercisesForGroup(long group_id) {

        return mDb.query(DATABASE_EXCERCISES_TABLE, new String[] {KEY_ROWID, KEY_TITLE,
    ...
    public Cursor fetchExcercise(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_EXCERCISES_TABLE, new String[] {KEY_ROWID,
    ...
    public boolean updateExcercise(long rowId, String title, String desc, int type, long group_id, long site_id) {
        ...
        return mDb.update(DATABASE_EXCERCISES_TABLE, args, KEY_ROWID + "=" + rowId, null) > 0;
    }
    ...
    public long createLogEntry(long excercise_id, float weight, int times, int program_id, int day) {
        ContentValues initialValues = new ContentValues();
        initialValues.put(KEY_EXCERCISEID, excercise_id);
    ...
    public Cursor fetchLogEntry(long rowId) throws SQLException {
        ...
        Cursor mCursor =
                ...
                mDb.query(true, DATABASE_LOG_TABLE, new String[] {KEY_ROWID, KEY_EXCERCISEID,
    ...
    public boolean updateLogEntry(long rowId, long excercise_id, float weight, int times, int program_id, int day) {
        ContentValues args = new ContentValues();
        args.put(KEY_EXCERCISEID, excercise_id);
