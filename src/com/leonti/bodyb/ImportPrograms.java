...
import com.leonti.bodyb.ImportExercises.MyExpandableListAdapter;
...
public class ImportPrograms extends ListActivity {
    ...
    public void fillList() throws JSONException{
        ...
        SimpleAdapter programs = new MySimpleAdapter(this, programsData, R.layout.import_programs_list_row,
                from, to);
    ...
    private class MySimpleAdapter extends SimpleAdapter{
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			cb.setChecked(Boolean.parseBoolean(programsData.get(position).get("checked")));
			
			cb.setOnClickListener(new OnClickListener() {
			    public void onClick(View v) {
			    	CheckBox clickedCheckbox = (CheckBox)v;
			    	programsData.get(position).put("checked", String.valueOf(clickedCheckbox.isChecked()));
			      }
			  });
    ...
    private class FetchPrograms extends AsyncTask<Void, Integer, Long> {
    	...
    	private ProgressDialog mProgress = new ProgressDialog(ImportPrograms.this);
        ...
        protected void onPostExecute(Long result) {
        	...
        	if(mResult == ServerJson.NO_CONNECTION){
        		Toast.makeText(ImportPrograms.this, R.string.no_connection, Toast.LENGTH_LONG).show(); 
        	}
        }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        programsData.get(position).put("checked", String.valueOf(cb.isChecked()));
    ...
    private class doImport extends AsyncTask<Void, Integer, Long> {
        ...
        protected void onPostExecute(Long result) {
        	mProgress.dismiss();
    		Toast.makeText(ImportPrograms.this, R.string.programs_imported, Toast.LENGTH_LONG).show();
			finish();
        	if(mResult == ServerJson.NO_CONNECTION){
        		Toast.makeText(ImportPrograms.this, R.string.no_connection, Toast.LENGTH_LONG).show(); 
        	}
