...
public class ProgramView extends Activity {
    ...
    public void addWeek(TableLayout tl, int startDay){
	    ...
	    for(int i = startDay; i < startDay + 7; i++){
	    	...
	    	if(mProgramSetsCursor.getCount() > 0){
	    		...
	    		Long dayNumber = mProgramSetsCursor.getLong(
	    				mProgramSetsCursor.getColumnIndexOrThrow(ExcercisesDbAdapter.KEY_DAY_NUMBER));
    ...
    protected void onActivityResult(int requestCode, int resultCode, 
        ...
        case ACTIVITY_ADD_SET:
        	Toast.makeText(this, R.string.plan_added, Toast.LENGTH_SHORT).show();
        	break;
        }
    }
