...
public class ProgramsList extends ListActivity {
    ...
    private void fillData() {
        ...
        SimpleCursorAdapter programs = 
        	    new SimpleCursorAdapter(this, R.layout.program_list_row, mProgramsCursor, from, to);
    ...
    protected void onActivityResult(int requestCode, int resultCode, 
        ...
        switch(requestCode) {
        case ACTIVITY_EDIT:
        	Toast.makeText(this, R.string.program_edited, Toast.LENGTH_SHORT).show();
        	break;
        }
    }
