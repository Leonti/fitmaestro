...
public class MeasurementEdit extends Activity {
	...
	private void populateFields() {
		...
		if (mRowId != null) {
			...
			mTitleText.setText(measurement.getString(measurement
					.getColumnIndexOrThrow(ExcercisesDbAdapter.KEY_TITLE)));
			mUnitsText.setText(measurement.getString(measurement
					.getColumnIndexOrThrow(ExcercisesDbAdapter.KEY_UNITS)));
			mDescText.setText(measurement.getString(measurement
