...
public class Synchronization {
	...
	public void fillHashes() {
		...
		logFields.put("sessions_detail_id",
				ExcercisesDbAdapter.KEY_SESSIONS_DETAILID);
		...
		sessions_connectorFields.put("session_id",
				ExcercisesDbAdapter.KEY_SESSIONID);
		sessions_connectorFields.put("exercise_id",
				ExcercisesDbAdapter.KEY_EXERCISEID);

		sessions_detailFields.put("sessions_connector_id",
				ExcercisesDbAdapter.KEY_SESSIONS_CONNECTORID);
		...
		sets_detailFields.put("sets_connector_id",
				ExcercisesDbAdapter.KEY_SETS_CONNECTORID);
		...
		measurements_logFields.put("measurement_type_id",
				ExcercisesDbAdapter.KEY_MEASUREMENT_TYPEID);
	...
	public JSONObject updateItems(JSONObject jsonUpdateData)
		...
		JSONArray setsReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_SETS_TABLE, sets, setFields);
		...
		JSONArray sets_connectorReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_SETS_CONNECTOR_TABLE,
		...
		JSONArray sets_detailReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_SETS_DETAIL_TABLE, sets_detail,
				sets_detailFields);
		...
		JSONArray programsReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_PROGRAMS_TABLE, programs,
				programFields);
		...
		JSONArray programs_connectorReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_PROGRAMS_CONNECTOR_TABLE,
		...
		JSONArray sessionsReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_SESSIONS_TABLE, sessions,
				sessionFields);
		...
		JSONArray sessions_connectorReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_SESSIONS_CONNECTOR_TABLE,
		...
		JSONArray sessions_detailReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_SESSIONS_DETAIL_TABLE,
		...
		JSONArray logReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_LOG_TABLE, log, logFields);
		...
		JSONArray measurement_typesReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_MEASUREMENT_TYPES_TABLE,
		...
		JSONArray measurements_logReturn = performItemsUpdate(
				ExcercisesDbAdapter.DATABASE_MEASUREMENTS_LOG_TABLE,
		...
		try {
			...
			dataToSend
					.put("log", prepareItems(
							ExcercisesDbAdapter.DATABASE_LOG_TABLE, logFields,
							updated));
