package com.leonty.fitmaesto.remote;
...
public class ServerJson {
	...
	public static final String address = "http://www.fitmaestro.com/";
	...
	public int registerUser(String email, String password,
		...
		try {
			...
			if (result.equals("CREATED")) {
				synchro.setAuthKey(jsonAnswer.get("authkey").toString());
	...
	public JSONObject finishUpdates(String authKey, JSONObject sendSecondData) {
		...
		try {
			jsonSend.put("what", "UPDATEPHONEIDS");
			jsonSend.put("authkey", authKey);
			...
			if (result.equals("PHONEIDSUPDATED")) {
				return jsonAnswer.getJSONObject("data");
			}
